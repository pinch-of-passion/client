...
const SearchSpoonacularRecipe = () => {
    ...
    //         tmp = ``;
    //         excludeIngredients.forEach((ing) => {
    //             tmp += `${ing},`
    //         })
    //         tmp.slice(0, -1)
    //         url += `excludeIngredients=${tmp}&`
    //     }
    //     if (includeIngredients.length != 0) {
    //         tmp = ``;
    //         includeIngredients.forEach((ing) => {
    //             tmp += `${ing},`
    //         })
    //         tmp.slice(0, -1)
    //         url += `includeIngredients=${tmp}&`
    //     }
    //     if (selectedDiet.length != 0) {
    //         tmp = ``;
    //         selectedDiet.forEach((ing) => {
    //             tmp += `${ing},`
    //         })
    //         tmp.slice(0, -1)
    //         url += `selectedDiet=${tmp}&`
    //     }
    //     return url;
    // }
